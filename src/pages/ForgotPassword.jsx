    ...
    <div className="min-h-screen flex bg-white font-sans overflow-x-hidden">
      ...
      <div className="hidden lg:flex lg:w-[40%] xl:w-[35%] bg-blue-900 relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Seguridad"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-blue-900 via-blue-800/10 to-transparent" />
        </div>
      ...
      <div className="w-full lg:w-[60%] xl:w-[65%] flex items-center justify-center p-6 sm:p-12 lg:p-20">
        <div className="w-full max-w-[420px] flex flex-col min-h-[550px]">
          ...
          <Link
            to="/login"
            className="flex items-center gap-2 text-slate-400 hover:text-blue-600 font-black text-[10px] uppercase tracking-[0.2em] mb-12 transition-colors w-fit group"
          >
          ...
          {!submitted ? (
            <>
              <div className="mb-10 text-center lg:text-left">
                <h1 className="text-4xl sm:text-5xl font-black text-slate-900 tracking-tighter mb-4 uppercase">
                  Recuperar <span className="text-blue-600 italic">Acceso</span>
                </h1>
                <p className="text-slate-500 font-medium text-lg leading-relaxed">
                  Ingresa tu correo registrado para restablecer tu cuenta.
                </p>
              </div>
              ...
              <form onSubmit={handleReset} className="space-y-6">
                ...
                <div className="flex justify-center pt-4">
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-10 py-3 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] bg-blue-600 text-white hover:bg-blue-700 transition-all duration-300 shadow-lg shadow-blue-600/30 active:scale-95 flex items-center justify-center gap-3"
                  >
                    {loading ? (
            ...
            <div className="bg-white border border-slate-100 p-10 rounded-[2.5rem] text-center space-y-6 shadow-2xl shadow-slate-200/50">
              <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center mx-auto shadow-xl shadow-blue-200">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-500 text-sm font-medium leading-relaxed">
                  ...
                  Redirigiendo al acceso en breve...
                </p>
              </div>
          ...
          <footer className="mt-auto pt-16 flex flex-col sm:flex-row justify-between items-center gap-6 border-t border-slate-100">
            <p className="text-slate-300 text-[9px] font-black uppercase tracking-[0.3em]">
              © 2026 EDIFICIOS COLOMBIA
            </p>
            <div className="flex gap-8">
              <a href="#" className="text-slate-400 hover:text-blue-600 text-[9px] font-black uppercase tracking-widest transition-colors">
                Ayuda
              </a>
              <a href="#" className="text-slate-400 hover:text-blue-600 text-[9px] font-black uppercase tracking-widest transition-colors">
                Legal
