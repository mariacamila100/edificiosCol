            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-16">
              {currentEdificios.map((edificio) => (
                ...
                >
                  ...
                  <div className="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] bg-slate-200 mb-6 shadow-2xl shadow-slate-200/50">
                    <img
                      src={edificio.imagen || edificio.foto || 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=800'}
                      alt={edificio.nombre}
                    ...
                    <div className="absolute top-6 left-6 flex flex-col gap-2">
                      ...
                      <div className="bg-white/95 backdrop-blur-md text-slate-900 px-4 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest flex items-center gap-2 self-start">
                    ...
                    <div className="absolute bottom-8 right-8 translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                      <div className="bg-white text-blue-900 p-4 rounded-full shadow-2xl">
